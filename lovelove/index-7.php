...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- Start header -->
        <?php
        $HeaderStyle = 'wpo-header-style-4';
        ?>
        <?php include './partials/header-three.php' ?>
        <!-- end of header -->
        <!-- start of hero -->
        <section class="static-hero-s3">
            <div class="container-fluid">
                <div class="wpo-hero-date">
                    <h2 class="wow fadeInUp" data-wow-duration="1500ms">Muhammad & Amatullah</h2>
                    <p class="wow fadeInUp" data-wow-duration="1700ms">We Are Getting Married November 15,2025</p>
                </div>
            </div>
        </section>
        <!-- end of hero slider -->
        <!-- start couple-section -->
        <section class="wpo-couple-section-s4 section-padding" id="couple">
            <div class="container">
                <div class="couple-area clearfix">
                    <div class="row ">
                        <div class="col col-md-4 col-12">
                            <div class="couple-item floating-item wow fadeInLeftSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="assets/images/couple/img-5.jpg" alt="">
                                </div>
                        ...
                        <div class="col col-md-4 col-12">
                            <div class="middle-couple-shape wow fadeInUp" data-wow-duration="1700ms">
                                <div class="middle-img">
                                    <img src="assets/images/couple/img-6.jpg" alt="">
                                </div>
                                <div class="shape">
                                    <img src="assets/images/couple/shape-4.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col col-md-4 col-12">
                            <div class="couple-item floating-item wow fadeInRightSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="assets/images/couple/img-7.jpg" alt="">
                                </div>
                                <div class="couple-text">
        ...
        <section class="wpo-video-section-s3">
            ...
            <div class="container-fluid">
                <div class="video-wrap">
                    <img src="assets/images/cta5.jpg" alt="">
                    <a href="https://www.youtube.com/embed/UpmJp0Tpjwo" class="video-btn" data-type="iframe"><i
        ...
        <section class="wpo-story-section-s4 section-padding pb-0" id="story">
            <div class="container">
        ...
        <section class="wpo-portfolio-section-s5 section-padding" id="gallery">
            <div class="container">
                <div class="wpo-section-title">
        ...
        <section class="wpo-partners-section section-padding pb-0">
