<div class="w-full bg-weddoLight">
  <div class="max-w-7xl mx-auto px-6 py-6 relative">
    ...
    <div id="storiesContainer" class="flex items-center gap-2 overflow-x-auto scrollbar-hide">
...
<div id="storyViewer" class="fixed inset-0 bg-black z-[99999] hidden flex items-center justify-center">
  ...
  <!-- Media -->
  <video id="storyVideo" class="max-h-full max-w-full object-contain" playsinline muted autoplay></video>

  <!-- Close -->
  <button id="closeStory" class="absolute top-6 right-6 text-white text-3xl">
    &times;
  </button>
</div>
