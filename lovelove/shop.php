                                    ...
                                    <div class="col col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="wpo-product-item">
                                            <div class="wpo-product-img">
                                                ...
                                                <ul>
                                                    <li><a href="wishlist.php"><i class="fi flaticon-heart"></i></a>
                                                    </li>
                        ...
                        <div class="wpo-shop-sidebar">
                            ...
                            <div class="widget woocommerce widget_product_categories">
                                ...
                                <ul class="product-categories">
                                    ...
                                    <li class="cat-item">
                                        <a href="#">Wedding Invitation & Gifts</a>
                                    </li>
                                    <li class="cat-item">
                            ...
                            <div class="widget widget_best-seller">
                                <h3>BEST SELLERS</h3>
                                <div class="wpo-best-seller-item">
                                    <div class="wpo-best-seller-img">
                                        <img src="assets/images/best-seller/1.jpg" alt="">
                                    </div>
                                    <div class="wpo-best-seller-text">
                                        <h4>Wedding Shoes</h4>
                                        <span>$220.00</span>
                                    </div>
                                </div>
                            ...
                            <div class="widget wpo-instagram-widget">
                                ...
                                <ul class="d-flex">
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/1.jpg"
                                                alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/2.jpg"
                                                alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/3.jpg"
                                                alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/4.jpg"
                                                alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/5.jpg"
                                                alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/6.jpg"
                                                alt=""></a></li>
                                </ul>
                            </div>
                        </div>
