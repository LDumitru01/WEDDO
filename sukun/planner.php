        ...
        <section class="wpo-team-section section-padding">
            <div class="container">
                <div class="wpo-section-title">
                    <h4 class="poort-text poort-in-right">Our Team</h4>
                    <h2 class="poort-text poort-in-right">Awesome Organizers</h2>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1200ms">
                                ...
                                <div class="wpo-team-text">
                                    <h3><a href="team-single.php">Jenny Wilson</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1400ms">
                                ...
                                <div class="wpo-team-text">
                                    <h3><a href="team-single.php">Robert Fox</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1600ms">
                                ...
                                <div class="wpo-team-text">
                                    <h3><a href="team-single.php">Annette Black</a></h3>
                                    <span>Planner</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1800ms">
                                ...
                                <div class="wpo-team-text">
                                    <h3><a href="team-single.php">Jerome Bell</a></h3>
                                    <span>Assistant</span>
                                </div>
                            </div>
                        </div>
