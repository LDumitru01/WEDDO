                    ...
                    <div class="col-lg-8 col-12">
                        <div class="wpo-minimal-wrap">
                            ...
                            <ul>
                                <li class="video-holder">
                                    <a href="https://www.youtube.com/embed/OUB6zKc-Tos?autoplay=1" class="video-btn"
                        ...
                        <div class="wpo-p-details-section">
                            ...
                            <p>It uses a dictionary of over 200 Latin words, combined with a handful of model sentence
                                ...
                                therefore always free from repetition, injected humour,sure there isn't anything
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="blog-sidebar">
                            ...
                            <div class="widget category-widget">
                                <h3>Services</h3>
                                <ul>
                                    <li><a href="service-single.php">Wedding Event <span>5</span></a></li>
                                    <li><a href="service-single.php">Photography <span>7</span></a></li>
                                    <li><a href="service-single.php">Album <span>3</span></a></li>
                                    <li><a href="service-single.php">Wedding Dress<span>6</span></a></li>
                                    <li><a href="service-single.php">Best Gift <span>2</span></a></li>
                                    <li><a href="service-single.php">Wedding Tips <span>8</span></a></li>
                                </ul>
                            </div>
                            <div class="widget wpo-instagram-widget">
                                ...
                                <ul class="d-flex">
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/1.jpg" alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/2.jpg" alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/3.jpg" alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/4.jpg" alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/5.jpg" alt=""></a></li>
                                    <li><a href="portfolio-single.php"><img src="assets/images/instragram/6.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
