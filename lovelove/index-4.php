...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="wpo-static-hero">
            <div class="container-fluid">
                <div class="wpo-hero-date">
                    <h2 class="wow fadeInUp" data-wow-duration="1000ms">Esabella & William</h2>
                    <p class="wow fadeInUp" data-wow-duration="1200ms">We Are Getting Married November 15,2025</p>
                </div>
                <div class="wpo-hero-img-wrap">
                    <div class="row">
                        <div class="col col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="wpo-hero-img wow fadeInLeftSlow" data-wow-duration="1700ms">
                                <img src="assets/images/slider/s1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="wpo-hero-img wow zoomIn" data-wow-duration="1200ms">
                                <img src="assets/images/slider/s2.jpg" alt="">
                            </div>
                        </div>
                        <div class="col col-lg-4 col-md-4 col-sm-6 col-12">
                            <div class="wpo-hero-img wow fadeInRightSlow" data-wow-duration="1700ms">
        ...
        <section class="wpo-couple-section-s2 section-padding" id="couple">
            <div class="container">
                <div class="couple-area clearfix">
                    <div class="shape-1"><img class="wow fadeInLeftSlow" data-wow-duration="1700ms" src="assets/images/couple/shape-2.png" alt=""></div>
                    <div class="shape-2"><img class="wow fadeInRightSlow" data-wow-duration="1700ms" src="assets/images/couple/shape-3.png" alt=""></div>
        ...
        <section class="wpo-team-section pb-0">
            <div class="container">
                <div class="wpo-section-title">
                    <h4>Important Persons</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="1400ms">
                                ...
                                <div class="wpo-team-text">
                                    <h3><a href="team-single.php">Henry D’suza</a></h3>
                                    <span>Groomsman</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="2000ms">
                                <div class="wpo-team-img">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="2200ms">
                                <div class="wpo-team-img">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="wpo-team-item wow fadeInUp" data-wow-duration="2400ms">
                                <div class="wpo-team-img">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-xl-8 col-lg-6 col-md-12 col-12">
                        <div class="contact-img wow fadeInRightSlow" data-wow-duration="1700ms">
                            <img src="assets/images/contact/img-4.jpg" alt="">
                            ...
                            <div class="rsvp-info">
                                ...
                                <div class="btn"><a class="theme-btn" href="rsvp.php">Discover More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
